...
Landing page da Ana 3D: itens personalizados em impressão 3D. Compartilha o
mesmo backend Supabase e a mesma arquitetura de upload/análise/viewer 3D do
projeto Insight, isoladas por `client_id` (ver `supabase/migrations/20260905120000_p4_multi_client.sql`
e `src/config/app.config.js`).
