...
describe("metadata server-side", () => {
  ...
  it.each([
    [{ originalName: "vazio.stl", extension: "stl", sizeBytes: 0, clientSlug: "insight" }, "EMPTY_FILE"],
    [{ originalName: "peca.obj", extension: "obj", sizeBytes: 1.2, clientSlug: "insight" }, "EMPTY_FILE"],
    [{ originalName: "peca.3mf", extension: "3mf", sizeBytes: 10, mimeType: 42, clientSlug: "insight" }, "INVALID_MIME_TYPE"],
    [{ originalName: "peca.stl", extension: "stl", sizeBytes: 10, clientSlug: "Insight" }, "INVALID_CLIENT"],
    [{ originalName: "peca.stl", extension: "stl", sizeBytes: 10, clientSlug: "" }, "INVALID_CLIENT"],
    [{ originalName: "peca.stl", extension: "stl", sizeBytes: 10 }, "INVALID_CLIENT"]
